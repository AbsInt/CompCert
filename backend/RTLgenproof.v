...
Proof.
  exact (Genv.find_symbol_transf_partial TRANSL).
Qed.
...
Proof.
  exact (Genv.find_funct_ptr_transf_partial TRANSL).
Qed.
...
Proof.
  exact (Genv.find_funct_transf_partial TRANSL).
Qed.
...
Proof.
  exact (Genv.senv_transf_partial TRANSL).
Qed.
...
Proof.
  exact (eval_expr_ind3 ge sp e m
     transl_expr_prop
...
Proof.
  exact (eval_exprlist_ind3 ge sp e m
     transl_expr_prop
     transl_exprlist_prop
     transl_condexpr_prop
     transl_expr_Evar_correct
...
Proof.
  exact (eval_condexpr_ind3 ge sp e m
     transl_expr_prop
     transl_exprlist_prop
     transl_condexpr_prop
     transl_expr_Evar_correct
