...
- Caller-save registers that can be modified during a function call.
  ...
  We follow the x86-64 application binary interfaces (ABI)
...
Definition is_callee_save (r: mreg) : bool :=
  ...
  | AX | CX | DX => false
  | BX | BP => true
  | SI | DI => Archi.win64 (**r callee-save in ELF 64 bits *)
  | R8 | R9 | R10 | R11 => false
...
(** The result value of a function is passed back to
...
Proof.
  intros. 
  unfold loc_result, mreg_type; destruct (proj_sig_res sg); auto.
Qed.
...
Proof.
  unfold loc_arguments; intros. destruct Archi.win64 eqn:W64.
- (* WIN 64 bits *)
  assert (A: forall r, In r int_param_regs_win64 -> is_callee_save r = false) by (unfold is_callee_save; decide_goal).
...
- (* ELF 64 bits *)
  assert (A: forall r, In r int_param_regs_elf64 -> is_callee_save r = false) by (unfold is_callee_save; rewrite W64; decide_goal).
...
Proof.
  unfold loc_arguments; destruct Archi.win64; auto.
Qed.
